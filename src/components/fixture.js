  ...
  return (
    <div className="pb-10 bg-white">
      ...
      <div align="center" className="grid grid-cols-1 divide-y">
        <h1 className=" bg-red-700 p-1 text-white text-xl">События</h1>
      ...
      <div align="center" className="grid grid-cols-1 divide-y">
        <h1 className=" bg-red-700 p-1 text-white text-xl">Счёт</h1>
      ...
      <div align="center" className="grid grid-cols-1 divide-y">
        <h1 className=" bg-red-700 p-1 text-white text-xl">
          Детали матча
        </h1>

        <div className="p-2">Стадион - {fixture.fixture.venue.name}</div>

        <div className="p-2">Судья - {fixture.fixture.referee}</div>
        <div className="p-2">Страна - {fixture.league.country}</div>
        <div className="p-2">{fixture.league.round}</div>
        <div className="p-2">{fixture.league.season}</div>
      </div>

      <div className="text-center">
        <button className="btn btn-wide bg-red-700 text-white">Оплатить за Live</button>
      </div>
    </div>
  );
}
